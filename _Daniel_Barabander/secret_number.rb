...
def guessNum secretNumber
	counter = 3
	while (counter > 0)
			counter -= 1
			puts secretNumber
			puts "Please guess a number 1-10"
			...
			elsif guessNumber != secretNumber 
				puts "Try again!, You have #{counter} guesses left"
...
#         if guessNumber != @secretNumber && counter != 0
#                 counter -= 1
#                 puts "You have #{counter} guesses left. Fail!"
#         elsif counter ==0
#             puts "Sorry you lost."
#         else
#                 puts "Congrats! You guessed the secret number of #{secretNumber}"
